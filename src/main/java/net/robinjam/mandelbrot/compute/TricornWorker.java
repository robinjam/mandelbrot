...
/**
 * Handles rendering the Tricorn fractal.
 * 
 * @author James Robinson
 */
public class TricornWorker extends Worker {

	private TricornWorker(Viewport viewport, int row) {
		super(viewport, row);
	}
	...
	public static WorkerFactory getFactory() {
		return new WorkerFactory() {
			...
			public Worker create(Viewport viewport, int row) {
				return new TricornWorker(viewport, row);
			}
